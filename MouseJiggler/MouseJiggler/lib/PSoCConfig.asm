...
export LoadConfig_mousetwitcher
export _LoadConfig_mousetwitcher
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_mousetwitcher
	lcall	LoadConfigTBL_mousetwitcher_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration mousetwitcher
;
;    Load configuration registers for mousetwitcher.
...
;               CUR_PP
;
_LoadConfig_mousetwitcher:
 LoadConfig_mousetwitcher:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_mousetwitcher_Bank0
    mov     X, <LoadConfigTBL_mousetwitcher_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_mousetwitcher_Bank1
    mov     X, <LoadConfigTBL_mousetwitcher_Bank1
