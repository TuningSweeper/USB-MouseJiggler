...
export LoadConfigTBL_mousetwitcher_Bank1
export LoadConfigTBL_mousetwitcher_Bank0
export LoadConfigTBL_mousetwitcher_Ordered
AREA lit(rom, rel)
LoadConfigTBL_mousetwitcher_Bank0:
...
;  Global Register values Bank 0
	...
	db		63h, 00h		; AnalogReferenceControl register (ARF_CR)
	...
	db		ffh
LoadConfigTBL_mousetwitcher_Bank1:
;  Instance name SleepTimer, User Module SleepTimer
;  Instance name USBFS, User Module USBFS
...
LoadConfigTBL_mousetwitcher_Ordered:
